...
public enum TypeEra { Gen1, Gen2to5, Gen6Plus }
...
public static class TypeChartService
{
    ...
    public static readonly IReadOnlyList<MoveType> Gen1Types = [
    ...
    public static readonly IReadOnlyList<MoveType> Gen2to5Types = [
        MoveType.Normal, MoveType.Fighting, MoveType.Flying, MoveType.Poison,
        MoveType.Ground, MoveType.Rock, MoveType.Bug, MoveType.Ghost,
    ...
    public static readonly IReadOnlyList<MoveType> AllTypes = [
        MoveType.Normal, MoveType.Fighting, MoveType.Flying, MoveType.Poison,
        MoveType.Ground, MoveType.Rock, MoveType.Bug, MoveType.Ghost,
        MoveType.Steel, MoveType.Fire, MoveType.Water, MoveType.Grass,
        MoveType.Electric, MoveType.Psychic, MoveType.Ice, MoveType.Dragon,
    ...
    private static float[,] BuildGen6PlusChart()
    {
        ...
        // Fighting defending
        c[Fl, Fi] = 2f; c[Ps, Fi] = 2f; c[Fa, Fi] = 2f;
        c[R, Fi] = .5f; c[B, Fi] = .5f; c[Dk, Fi] = .5f;

        // Flying defending
        c[E, Fl] = 2f;  c[I, Fl] = 2f;  c[R, Fl] = 2f;
        c[Fi, Fl] = .5f; c[B, Fl] = .5f; c[Gr, Fl] = .5f; c[G, Fl] = 0f;

        // Poison defending
        c[G, P] = 2f;   c[Ps, P] = 2f;
        c[Fi, P] = .5f; c[P, P] = .5f; c[B, P] = .5f; c[Gr, P] = .5f; c[Fa, P] = .5f;

        // Ground defending
        c[Gr, G] = 2f;  c[I, G] = 2f;  c[W, G] = 2f;
        c[P, G] = .5f;  c[R, G] = .5f; c[E, G] = 0f;

        // Rock defending
        c[Fi, R] = 2f;  c[Gr, R] = 2f; c[G, R] = 2f;  c[St, R] = 2f; c[W, R] = 2f;
        c[Fr, R] = .5f; c[Fl, R] = .5f; c[N, R] = .5f; c[P, R] = .5f;

        // Bug defending
        c[Fr, B] = 2f;  c[Fl, B] = 2f;  c[R, B] = 2f;
        c[Fi, B] = .5f; c[Gr, B] = .5f; c[G, B] = .5f;

        // Ghost defending
        c[Dk, Gh] = 2f; c[Gh, Gh] = 2f;
        c[B, Gh] = .5f; c[P, Gh] = .5f; c[N, Gh] = 0f; c[Fi, Gh] = 0f;

        // Steel defending (Gen 6+: does NOT resist Ghost or Dark)
        c[Fi, St] = 2f;  c[Fr, St] = 2f;  c[G, St] = 2f;
        c[B, St] = .5f;  c[Dr, St] = .5f; c[Fa, St] = .5f; c[Fl, St] = .5f;
        c[Gr, St] = .5f; c[I, St] = .5f;  c[N, St] = .5f;  c[Ps, St] = .5f;
        c[R, St] = .5f;  c[St, St] = .5f; c[P, St] = 0f;

        // Fire defending
        c[G, Fr] = 2f;   c[R, Fr] = 2f;   c[W, Fr] = 2f;
        c[B, Fr] = .5f;  c[Fa, Fr] = .5f; c[Fr, Fr] = .5f;
        c[Gr, Fr] = .5f; c[I, Fr] = .5f;  c[St, Fr] = .5f;

        // Water defending
        c[E, W] = 2f;   c[Gr, W] = 2f;
        c[Fr, W] = .5f; c[I, W] = .5f; c[St, W] = .5f; c[W, W] = .5f;

        // Grass defending
        c[B, Gr] = 2f;   c[Fr, Gr] = 2f;  c[Fl, Gr] = 2f; c[I, Gr] = 2f; c[P, Gr] = 2f;
        c[E, Gr] = .5f;  c[Gr, Gr] = .5f; c[G, Gr] = .5f; c[W, Gr] = .5f;

        // Electric defending
        c[G, E] = 2f;
        c[E, E] = .5f; c[Fl, E] = .5f; c[St, E] = .5f;

        // Psychic defending
        c[B, Ps] = 2f;  c[Dk, Ps] = 2f; c[Gh, Ps] = 2f;
        c[Fi, Ps] = .5f; c[Ps, Ps] = .5f;

        // Ice defending
        c[Fi, I] = 2f; c[Fr, I] = 2f; c[R, I] = 2f; c[St, I] = 2f;
        c[I, I] = .5f;

        // Dragon defending
        c[Dr, Dr] = 2f; c[Fa, Dr] = 2f; c[I, Dr] = 2f;
        c[E, Dr] = .5f; c[Fr, Dr] = .5f; c[Gr, Dr] = .5f; c[W, Dr] = .5f;

        // Dark defending
        c[B, Dk] = 2f;  c[Fa, Dk] = 2f; c[Fi, Dk] = 2f;
        c[Dk, Dk] = .5f; c[Gh, Dk] = .5f; c[Ps, Dk] = 0f;

        // Fairy defending
        c[P, Fa] = 2f;  c[St, Fa] = 2f;
        c[B, Fa] = .5f; c[Dk, Fa] = .5f; c[Fi, Fa] = .5f; c[Dr, Fa] = 0f;
